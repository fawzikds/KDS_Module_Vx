...
namespace Revit.SDK.Samples.RoutingPreferenceTools.CS
{
    ...
    internal class FindFolderUtility
    {
        ...
        public static List<string> GetAdditionalFamilyPaths()
        {
            ...
            try
            {
                ...
                //string strExeFilePath = System.Reflection.Assembly.GetExecutingAssembly().Location.ToString();
                var exePath = new Uri(System.Reflection.Assembly.GetExecutingAssembly().CodeBase).LocalPath;
                string strExeFilePath = new FileInfo(exePath).DirectoryName;
                reader = new StreamReader(strExeFilePath + "\\familypaths.xml");
            }
            catch (System.Exception ex)
            {
                Autodesk.Revit.UI.TaskDialog.Show("RoutingPreferenceBuilderUtility", "GetAdditionalFamilyPaths Exception :  " + ex);
                return pathsList;
            }
    ...
    internal class SchemaValidationHelper
    {
        ...
        {
            Autodesk.Revit.UI.TaskDialog.Show("RoutingPreferenceBuilderUtility", "I am in ValidateRoutingPreferenceBuilderXml. ");
            message = "";
            XmlSchemaSet schemas = new XmlSchemaSet();
            Autodesk.Revit.UI.TaskDialog.Show("RoutingPreferenceBuilderUtility", "I am in ValidateRoutingPreferenceBuilderXml. Created schemas  ");
            schemas.Add("", XmlReader.Create(new StringReader(GetXmlSchema())));
            Autodesk.Revit.UI.TaskDialog.Show("RoutingPreferenceBuilderUtility", "I am in ValidateRoutingPreferenceBuilderXml. added XmlReader to schemas ");
            ...
            catch (System.Xml.Schema.XmlSchemaValidationException ex)
            {
                ...
                Autodesk.Revit.UI.TaskDialog.Show("RoutingPreferenceBuilderUtility", "I am in ValidateRoutingPreferenceBuilderXml. Exception : " + message);
                return false;
            }
        }
        ...
        private static string GetXmlSchema()
        {
            ...
            try
            {
                ...
                //schemaStream = System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("KDS_Module.RoutingPreferenceBuilderData.xsd");
                schemaStream = System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("KDS_Module.RoutingPreferenceBuilderData_ruleIndex.xsd");
